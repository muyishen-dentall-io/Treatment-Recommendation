...
class BPR_Recommender(Recommender):

    def __init__(self, args):
        self.args = args
        self.SAVE_PATH = 'results/BPR_Recommender/'
        return
    ...
    def train(self, train_df):
        ...
        self.model.fit(self.item_user_matrix.T)  # BPR expects item-user matrix
    ...
    def evaluate(self, val_df, top_k):
        ...
        with open(self.SAVE_PATH + "BPR_Recommender_top{}.txt".format(top_k), "w", encoding="utf-8") as f:
            def log(msg):
                print(msg)
                f.write(msg + "\n")
